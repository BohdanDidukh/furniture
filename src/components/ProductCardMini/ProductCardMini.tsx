...
const ProductCardMini: FC<ProductCardMiniProps> = ({ product }) => (
  <div className={styles.ProductCardMini} key={product.id}>
    <div className={styles.ProductCardMini__info}>
      <img alt="" src={product.image} className={styles.ProductCardMini__img} />
    ...
    <div className={styles.ProductCardMini__action}>
      ...
      <button className={styles.ProductCardMini__button}>
        <svg
          width="21"
          height="20"
          viewBox="0 0 21 20"
